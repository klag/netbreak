...
\section{Processi di supporto}
	...
	Il processo di Verifica ha lo scopo di controllare ed assicurare che ogni documento prodotto rispecchi quanto previsto dai requisiti.
		...
		\subsubsection{Analisi}
			...
			L'analisi statica è applicata ai documenti di testo, consiste nel trovare errori sintattici e ortografici. Una prima verifica viene effettuata dai \textit{\Vers} e, successivamente, dal \textit{\RdP}. Le due tecniche scelte sono la \textbf{\textit{Formal Walkthrough\ped{G}}} e la \textbf{\textit{Fagan Inspection\ped{G}}}.
			\begin{itemize}
		...
		\begin{itemize}
			\item \textbf{W3C Markup Validator Service\ped{G}}: validatore online di codice HTML\ped{G}, utile per trovare eventuali errori nel codice. L'indirizzo web di riferimento è: \url https://validator.w3.org/;
			\item \textbf{CSSLint\ped{G}}: validatore online di codice CSS\ped{G}, utile per trovare eventuali errori nel codice. L'indirizzo web di riferimento è: \url http://csslint.net/;
			\item \textbf{SQLFiddle\ped{G}}: validatore online di codice MySQL\ped{G}. Utile per verificare la consistenza del codice del database\ped{G}. L'indirizzo web di riferimento è: \url http://sqlfiddle.com/;
			\item \textbf{PHP Code Checker\ped{G}}: strumento online che verifica la presenza di eventuali errori di sintassi nel codice PHP\ped{G}. L'indirizzo web di riferimento è: \url http://phpcodechecker.com/.
		\end{itemize}