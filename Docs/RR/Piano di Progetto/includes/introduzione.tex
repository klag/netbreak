...
Lo scopo del prodotto è la realizzazione di un \textit{API Market\ped{\textit{G}}} per l'acquisto e la vendita di \textit{microservizi\ped{G}}. Il sistema offrirà la possibilità di registrare nuove \textit{API\ped{\textit{G}}} per la vendita, permetterà la consultazione e la ricerca di \textit{API\ped{\textit{G}}} ai potenziali acquirenti, gestendo i permessi di accesso ed utilizzo tramite creazione e controllo di relative \textit{API key\ped{\textit{G}}}. Il sistema, oltre alla \textit{web app\ped{G}} stessa, sarà corredato di un \textit{API Gateway\ped{\textit{G}}} per la gestione delle richieste e il controllo delle chiavi, e fornirà funzionalità avanzate di statistiche per il gestore della piattaforma e per i fornitori dei \textit{microservizi\ped{G}}.
