...
in ambiente Android\ped{\textit{G}} per dispositivi mobili, come smartphone e tablet,
...
\begin{itemize}
	\item \textbf{FA-TTS\ped{\textit{G}}} (\textbf{F}lexible and \textbf{A}daptive \textbf{T}ext-\textbf{T}o-\textbf{S}peech),
	come motore di sintesi vocale open-source;
	\item \textbf{Android\ped{\textit{G}}}, come piattaforma ed ambiente di sviluppo;
	\item \textbf{Java\ped{\textit{G}}}, come linguaggio di programmazione per lo sviluppo dell'applicazione
	(vincolato dalla scelta di Android\ped{\textit{G}} come piattaforma);
	\item \textbf{ePub\ped{\textit{G}}}, come libreria open-source per lo sviluppo di un e-book
	reader;
	\item \textbf{Telegram\ped{\textit{G}}}, come client di messaggistica open-source.
\end{itemize}
...
l'azienda committente suggerisce l'utilizzo dell'engine FA-TTS\ped{\textit{G}},
...
la sintesi vocale sia una tecnologia in forte sviluppo ed utilizzo, la realizzazione di un'applicazione in ambiente Android\ped{\textit{G}} destinata
a dispositivi mobile, non è per niente banale. Android\ped{\textit{G}} è una piattaforma
