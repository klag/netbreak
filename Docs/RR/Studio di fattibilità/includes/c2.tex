...
di comunicazione già esistente, basato su Slack\ped{\textit{G}}, per notificare l'arrivo dei visitatore. Tra le funzionalità obbligatorie da fornire,
...
all'interessato tramite Slack\ped{\textit{G}}. Il software dovrà utilizzare obbligatoriamente
...
con l'utente, i servizi AWS Lambda\ped{\textit{G}} per l'interazione con l'API\ped{\textit{G}} dell'assistente
...
è destinato a tutte le aziende che utilizzano Slack\ped{\textit{G}}: un buon punto di forza vista
...
\begin{itemize}
	\item \textbf{HTML5\ped{\textit{G}}, CSS3\ped{\textit{G}}} e \textbf{Javascript\ped{\textit{G}}}, per lo sviluppo dell'interfaccia web;
	\item \textbf{Bootstrap3\ped{\textit{G}}}, come framework\ped{\textit{G}} CSS\ped{\textit{G}};
	\item \textbf{NodeJS\ped{\textit{G}}} o \textbf{Swift\ped{\textit{G}}}, come linguaggio di programmazione per lo
	sviluppo dell'applicazione;
	\item \textbf{Express\ped{\textit{G}}}, come eventuale framework\ped{\textit{G}} NodeJS\ped{\textit{G}};
	\item \textbf{Amazon Web Services\ped{\textit{G}}}, come infrastruttura di cloud computing\ped{\textit{G}};
	\item \textbf{MongoDB\ped{\textit{G}}} o \textbf{DynamoDB\ped{\textit{G}}}, come database NoSQL\ped{\textit{G}};
	\item \textbf{SiriSDK\ped{\textit{G}}} o \textbf{AlexaSDK\ped{\textit{G}}}, come assistenti virtuali.
\end{itemize}

\subsection{Aspetti critici}

Un punto cruciale del progetto riguarda la capacità di progettare
correttamente le interfacce rivolte ai servizi AWS Lambda\ped{\textit{G}}. Questi
gestiranno lo scambio di dati tra gli utenti e gli altri elementi
interni quali Slack\ped{\textit{G}}, database ed assistente virtuale. L'apprendimento e l'integrazione di un numero relativamente alto di nuove tecnologie potrebbe, inizialmente, disorientare e far perdere la visione d'insieme del progetto.
