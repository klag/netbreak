...
\begin{longtable}{ l | p{11cm}}
	...
	\begin{enumerate*}[label=(\arabic*.),itemjoin={\newline}]
		...
		\item L'attore può inserire il link per la documentazione esterna della nuova API (UC11.6)
		\item L'attore può inserire il prezzo base della nuova API (UC11.7)
		\item L'attore può confermare la registrazione della nuova API (UC11.8)
	\end{enumerate*}\\
	\textbf{Scenario Principale} & 
	\begin{enumerate*}[label=(\arabic*.),itemjoin={\newline}]
			\item L'attore può visualizzare un messaggio d'errore informativo riguardo la conferma della registrazione dell'API, e la registrazione non avviene (UC11.9)
			\item L'attore può visualizzare un messaggio di errore riguardo al caricamento del file di documentazione PDF dell'API, ed il caricamento del file non avviene (UC11.10)
		\end{enumerate*}\\
\end{longtable}
...
\paragraph{Caso d'uso UC11.4: Inserimento interfaccia API}
\label{UC11_4}
...
\paragraph{Caso d'uso UC11.5: Inserimento documentazione PDF API}
\label{UC11_5}
...
\subparagraph{Caso d'uso UC11.10: Errore inserimento PDF API}
\label{UC11_10}
...
\begin{minipage}{\linewidth}
	\begin{tabular}{ l | p{11cm}}
		\hline
		\rowcolor{Gray}
		\multicolumn{2}{c}{UC11.10 - Errore inserimento PDF API} \\
		\hline
		\textbf{Attori} & Utente autenticato, Amministratore API Market \\
...
\paragraph{Caso d'uso UC11.6: Inserimento documentazione esterna API}
\label{UC11_6}
...
\begin{minipage}{\linewidth}
	\begin{tabular}{ l | p{11cm}}
		\hline
		\rowcolor{Gray}
		\multicolumn{2}{c}{UC11.6 - Inserimento documentazione esterna API} \\
		\hline
		\textbf{Attori} & Utente autenticato, Amministratore API Market \\
...
\paragraph{Caso d'uso UC11.7: Inserimento prezzo base API}
\label{UC11_7}
...
\begin{minipage}{\linewidth}
	\begin{tabular}{ l | p{11cm}}
		\hline
		\rowcolor{Gray}
		\multicolumn{2}{c}{UC11.7 - Inserimento prezzo base API} \\
		\hline
		\textbf{Attori} & Utente autenticato, Amministratore API Market \\
...
\paragraph{Caso d'uso UC11.8: Conferma registrazione nuova API}
\label{UC11_8}
...
\begin{minipage}{\linewidth}
	\begin{tabular}{ l | p{11cm}}
		\hline
		\rowcolor{Gray}
		\multicolumn{2}{c}{UC11.8 - Conferma registrazione nuova API} \\
		\hline
		\textbf{Attori} & Utente autenticato, Amministratore API Market \\
...
\paragraph{Caso d'uso UC11.9: Errore registrazione nuova API}
\label{UC11_9}
...
\begin{minipage}{\linewidth}
	\begin{tabular}{ l | p{11cm}}
		\hline
		\rowcolor{Gray}
		\multicolumn{2}{c}{UC11.9 - Errore registrazione nuova API} \\
		\hline
		\textbf{Attori} & Utente autenticato, Amministratore API Market \\
