...
\subsubsection{Caso d'uso UC9.2: Scelta licenza API}
\label{UC9_2}
...
\begin{minipage}{\linewidth}
	\begin{tabular}{ l | p{11cm}}
		\hline
		\rowcolor{Gray}
		\multicolumn{2}{c}{UC9.2 - Scelta licenza API} \\
		\hline
		\textbf{Attori} & Utente autenticato, Amministratore API Market \\
		...
		\textbf{Scenario Principale} & 
		\begin{enumerate*}[label=(\arabic*.),itemjoin={\newline}]
			\item L'attore può selezionare la licenza desiderata per l'API selezionata
		\end{enumerate*}\\
	\end{tabular}
\end{minipage}

\paragraph{Caso d'uso UC9.2.1: Scelta licenza per numero di chiamate}
\label{UC9_2_1}
...
\begin{minipage}{\linewidth}
	\begin{tabular}{ l | p{11cm}}
		\hline
		\rowcolor{Gray}
		\multicolumn{2}{c}{UC9.2.1 - Scelta licenza per numero di chiamate} \\
		\hline
		\textbf{Attori} & Utente autenticato, Amministratore API Market \\
...
\paragraph{Caso d'uso UC9.2.2: Scelta licenza per tempo di utilizzo}
\label{UC9_2_2}
...
\begin{minipage}{\linewidth}
	\begin{tabular}{ l | p{11cm}}
		\hline
		\rowcolor{Gray}
		\multicolumn{2}{c}{UC9.2.2 - Scelta licenza per tempo di utilizzo} \\
		\hline
		\textbf{Attori} & Utente autenticato, Amministratore API Market \\
...
\paragraph{Caso d'uso UC9.2.3: Scelta licenza per traffico}
\label{UC9_2_3}
...
\begin{minipage}{\linewidth}
	\begin{tabular}{ l | p{11cm}}
		\hline
		\rowcolor{Gray}
		\multicolumn{2}{c}{UC9.2.3 - Scelta licenza per traffico} \\
		\hline
		\textbf{Attori} & Utente autenticato, Amministratore API Market \\
...
\begin{minipage}{\linewidth}
	\begin{tabular}{ l | p{11cm}}
		...
		\textbf{Scenario Principale} & 
		\begin{enumerate*}[label=(\arabic*.),itemjoin={\newline}]
			\item L'attore può visualizzare una previsione del proprio saldo finale qualora acquistasse l'API con la licenza scelta in UC9.2
		\end{enumerate*}\\
	\end{tabular}
\end{minipage}
