...
\begin{longtable}{ l | p{11cm}}
	...
	\begin{enumerate*}[label=(\arabic*.),itemjoin={\newline}]
		\item L'attore può scegliere una API (UC14.1) per visualizzarne i dati di utilizzo avanzati (UC14.1.1)
		\item L'attore può scegliere un utente (UC14.2.1) da moderare (UC14.2.1.1)
	\end{enumerate*}\\
\end{longtable}
...
\begin{minipage}{\linewidth}
	\begin{tabular}{ l | p{11cm}}
		...
		\textbf{Scenario Principale} & 
		\begin{enumerate*}[label=(\arabic*.),itemjoin={\newline}]
			\item L'attore può scegliere una API su cui visualizzare i dati di utilizzo avanzati (UC14.1.1)
		\end{enumerate*}\\
	\end{tabular}
\end{minipage}

\newpage
\subsubsection{Caso d'uso UC14.1.1: Visualizzazione dati di utilizzo avanzati}
\label{UC14_1_1}
\begin{figure}[ht]
	\centering
...
\begin{minipage}{\linewidth}
	\begin{tabular}{ l | p{11cm}}
		\hline
		\rowcolor{Gray}
		\multicolumn{2}{c}{UC14.1.1 - Visualizzazione dati di utilizzo avanzati} \\
		\hline
		\textbf{Attori} &  Amministratore API Market \\
...
\newpage
\paragraph{Caso d'uso UC14.1.1.5: Visualizzazione utenti con licenza attiva}
\label{UC14_1_1_5}
\begin{figure}[ht]
	\centering
	\includegraphics[scale=0.45]{UML/UC14_1_1_5.png}
...
\begin{minipage}{\linewidth}
	\begin{tabular}{ l | p{11cm}}
		\hline
		\rowcolor{Gray}
		\multicolumn{2}{c}{UC14.1.1.5 - Visualizzazione utenti con licenza attiva} \\
		\hline
		\textbf{Attori} & Amministratore API Market \\
...
\subparagraph{Caso d'uso UC14.1.1.5.1: Visualizzazione lista nomi utenti}
\label{UC14_1_1_5_1}
...
\begin{minipage}{\linewidth}
	\begin{tabular}{ l | p{11cm}}
		\hline
		\rowcolor{Gray}
		\multicolumn{2}{c}{UC14.1.1.5.1 - Visualizzazione lista nomi utenti} \\
		\hline
		\textbf{Attori} & Amministratore API Market \\
...
\subparagraph{Caso d'uso UC14.1.1.5.2: Visualizzazione lista data di scadenza licenza}
\label{UC14_1_1_5_2}
...
\begin{minipage}{\linewidth}
	\begin{tabular}{ l | p{11cm}}
		\hline
		\rowcolor{Gray}
		\multicolumn{2}{c}{UC14.1.1.5.2 -  Visualizzazione lista data di scadenza licenza} \\
		\hline
		\textbf{Attori} & Amministratore API Market \\
...
\paragraph{Caso d'uso UC14.1.1.6: Visualizzazione tempo medio di risposta}
\label{UC14_1_1_6}
...
\begin{minipage}{\linewidth}
	\begin{tabular}{ l | p{11cm}}
		\hline
		\rowcolor{Gray}
		\multicolumn{2}{c}{UC14.1.1.6 - Visualizzazione tempo medio di risposta} \\
		\hline
		\textbf{Attori} & Amministratore API Market \\
...
\begin{minipage}{\linewidth}
	\begin{tabular}{ l | p{11cm}}
		...
		\begin{enumerate*}[label=(\arabic*.),itemjoin={\newline}]
			...
			\item L'attore può sospendere i prelievi dell'utente scelto dal rispettivo conto personale (UC14.2.1.2)
			\item L'attore può revocare la sospensione dell'utente scelto (UC14.2.1.3)
			\item L'attore può revocare la sospensione dei prelievi dell'utente scelto dal rispettivo conto personale (UC14.2.1.4)
		\end{enumerate*}\\
	\end{tabular}
\end{minipage}
...
\begin{minipage}{\linewidth}
	\begin{tabular}{ l | p{11cm}}
		...
		\textbf{Scenario Principale} & 
		\begin{enumerate*}[label=(\arabic*.),itemjoin={\newline}]
			\item L'attore può inserire la durata in giorni della sospensione dell'utente scelto (UC14.2.1.1.1)
			\item L'attore può confermare la sospensione dell'utente scelto (UC14.2.1.1.2)
		\end{enumerate*}\\
		\textbf{Scenari Alternativi} & 
		\begin{enumerate*}[label=(\arabic*.),itemjoin={\newline}]
			\item L'attore può visualizzare un messaggio di errore informativo e la sospensione dell'utente scelto non avviene (UC14.2.1.1.3)
		\end{enumerate*}\\
	\end{tabular}
\end{minipage}

\subparagraph{Caso d'uso UC14.2.1.1.1: Scelta durata sospensione utente}
\label{UC14_2_1_1_1}
...
\begin{minipage}{\linewidth}
	\begin{tabular}{ l | p{11cm}}
		\hline
		\rowcolor{Gray}
		\multicolumn{2}{c}{UC14.2.1.1.1 - Scelta durata sospensione utente} \\
		\hline
		\textbf{Attori} & Amministratore API Market \\
...
\subparagraph{Caso d'uso UC14.2.1.1.2: Conferma sospensione utente}
\label{UC14_2_1_1_2}
...
\begin{minipage}{\linewidth}
	\begin{tabular}{ l | p{11cm}}
		\hline
		\rowcolor{Gray}
		\multicolumn{2}{c}{UC14.2.1.1.2 - Conferma sospensione utente} \\
		\hline
		\textbf{Attori} & Amministratore API Market \\
...
\subparagraph{Caso d'uso UC14.2.1.1.3: Errore sospensione utente}
\label{UC14_2_1_1_3}
...
\begin{minipage}{\linewidth}
	\begin{tabular}{ l | p{11cm}}
		\hline
		\rowcolor{Gray}
		\multicolumn{2}{c}{UC13.2.1.3 - Errore sospensione utente} \\
		\hline
		\textbf{Attori} & Amministratore API Market \\
...
\begin{minipage}{\linewidth}
	\begin{tabular}{ l | p{11cm}}
		...
		\textbf{Scenario Principale} & 
		\begin{enumerate*}[label=(\arabic*.),itemjoin={\newline}]
			\item L'attore può sospendere a tempo indeterminato i prelievi dell'utente scelto dal rispettivo conto personale (UC14.2.1.2.1)
		\end{enumerate*}\\
		\textbf{Scenari Alternativi} & 
		\begin{enumerate*}[label=(\arabic*.),itemjoin={\newline}]
			\item L'attore può visualizzare un messaggio di errore informativo e la sospensione a tempo indeterminato dei prelievi dell'utente scelto dal rispettivo conto personale non avviene (UC14.2.1.2.2)
		\end{enumerate*}\\
	\end{tabular}
\end{minipage}

\subparagraph{Caso d'uso UC14.2.1.2.1: Conferma sospensione prelievi conto utente}
\label{UC14_2_1_2_1}
...
\begin{minipage}{\linewidth}
	\begin{tabular}{ l | p{11cm}}
		\hline
		\rowcolor{Gray}
		\multicolumn{2}{c}{UC14.2.1.2.1 - Conferma sospensione prelievi conto utente} \\
		\hline
		\textbf{Attori} & Amministratore API Market \\
...
\subparagraph{Caso d'uso UC14.2.1.2.2: Errore sospensione prelievi conto utente}
\label{UC14_2_1_2_2}
...
\begin{minipage}{\linewidth}
	\begin{tabular}{ l | p{11cm}}
		\hline
		\rowcolor{Gray}
		\multicolumn{2}{c}{UC14.2.1.2.2 - Errore sospensione prelievi conto utente} \\
		\hline
		\textbf{Attori} & Amministratore API Market \\
...
\paragraph{Caso d'uso UC14.2.1.4: Revoca sospensione prelievi conto utente}
\label{UC14_2_1_4}
...
\begin{minipage}{\linewidth}
	\begin{tabular}{ l | p{11cm}}
		\hline
		\rowcolor{Gray}
		\multicolumn{2}{c}{UC14.2.1.4 - Revoca sospensione prelievi conto utente} \\
		\hline
		\textbf{Attori} & Amministratore API Market \\
