...
\subsubsection{Considerazioni}
L'attività di progettazione ha causato diversi problemi e quindi un numero maggiore di ore impiegate. A causa di alcune incomprensioni progettuali e necessità di approfondire alcune situazioni critiche con il \textit{Proponente}, si è verificato uno scostamento in negativo di € 100, a causa di un maggior numero di ore impiegato durante l'attività di Progettazione.
A nostro giudizio, questo incremento del costo per realizzare una progettazione più accurata e completa, causerà meno problemi nel periodo di Codifica, dove stimiamo di utilizzare meno ore nella Programmazione e quindi riallineare il preventivo a finire con quello iniziale a carico del \textit{Proponente}.
