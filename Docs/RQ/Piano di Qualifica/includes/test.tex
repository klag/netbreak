...
Per avere un tracciamento dei test prodotti e dei risultati ottenuti, si è scelto di rappresentare delle tabelle di log di facile consultazione, le quali forniscono un'indicazione degli output delle attività di verifica, eventuali errori e/o risultati non coerenti con quanto fissato.
	...
	\begin{longtable}{|>{\centering\arraybackslash}p{2.3cm}|>{\centering\arraybackslash}p{7.5cm} | >{\centering\arraybackslash}p{3.8cm}|}
		...
		\hypertarget{TSFxxx}{TSFxxx} & Viene verificato che il sistema effettui correttamente l'upgrade dell'account di un utente. & \textit{Non Implementato}\\ \hline
		...
		\hypertarget{TSVOxx}{TSFOxx} & Viene verificato che il sistema abbia un'architettura a microservizi. & \textit{Non Implementato}\\ \hline
		\hypertarget{TSVOxx}{TSFOxx} & Viene verificato che il sistema utilizzi il linguaggio \textit{Jolie} per l'API Gateway, il back-end dell'applicazione web e le interfacce dei microservizi. & \textit{Non Implementato}\\ \hline
		\hypertarget{TSVOxx}{TSVOxx} & Viene verificato che il sistema utilizzi il linguaggio di markup \textit{HTML5}. & \textit{Non Implementato}\\ \hline
		\hypertarget{TSVOxx}{TSVOxx} & Viene verificato che il sistema utilizzi fogli di stile in \textit{CSS3}. & \textit{Non Implementato}\\ \hline
		\hypertarget{TSVOxx}{TSVOxx} & Viene verificato che il sistema utilizzi il linguaggio \textit{JavaScript}. & \textit{Non Implementato}\\ \hline
		\hypertarget{TSVOxx}{TSVOxx} & Viene verificato che il sistema funzioni su \textit{Google Chrome} versione 55.0 o superiore & \textit{Non Implementato}\\ \hline
		\hypertarget{TSVOxx}{TSVOxx} & Viene verificato che il sistema funzioni su \textit{Mozilla Firefox} versione 51.0 o superiore & \textit{Non Implementato}\\ \hline
		\hypertarget{TSVOxx}{TSVOxx} & Viene verificato che il sistema funzioni su \textit{Safari} versione 10.0 o superiore & \textit{Non Implementato}\\ \hline
		\hypertarget{TSVDxx}{TSVDxx} & Viene verificato che il sistema funzioni su \textit{Opera} versione 42.0 o superiore & \textit{Non Implementato}\\ \hline
		\hypertarget{TSVDxx}{TSVDxx} & Viene verificato che il sistema funzioni su \textit{Internet Explorer} versione 11.0 o superiore & \textit{Non Implementato}\\ \hline
		\hypertarget{TSVOxx}{TSVOxx} & Viene verificato che il sistema funzioni su \textit{Microsoft Edge} versione 38.0 o superiore & \textit{Non Implementato}\\ \hline
		\hypertarget{TSVOxx}{TSVOxx} & Viene verificato che il sistema funzioni su \textit{Android Browser} versione 5.1 o superiore & \textit{Non Implementato}\\ \hline
		\hypertarget{TSVOxx}{TSVOxx} & Viene verificato che il sistema funzioni su \textit{Safari} per iOS 10 o versioni superiori & \textit{Non Implementato}\\ \hline
		\hypertarget{TSVFxx}{TSVFxx} & Viene verificato che il sistema funzioni su \textit{Google Chrome} per iOS versione 56.0 o superiore & \textit{Non Implementato}\\ \hline
		\hypertarget{TSVFxx}{TSVFxx} & Viene verificato che il sistema funzioni su \textit{Google Chrome} per Android versione 56.0 o superiore & \textit{Non Implementato}\\ \hline
