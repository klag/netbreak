			...
			\begin{table}[H]
				\begin{center}
					\begin{tabular}{|c|c|c|}
						...
						\textbf{Metodo di calcolo} & \textbf{Range accettazione} & \textbf{Range ottimale} \\
						\hline
						n° TU eseg/n° TU pianif & 95-100  & 100 \\
						\hline
					\end{tabular}
				\end{center}
			...
			\begin{table}[H]
				\begin{center}
					\begin{tabular}{|c|c|c|}
						...
						\textbf{Metodo di calcolo} & \textbf{Range accettazione} & \textbf{Range ottimale} \\
						\hline
						n° TI eseg/n° TI pianif & 65-100  & 75-100 \\
						\hline
					\end{tabular}
				\end{center}
			...
			\begin{table}[H]
				\begin{center}
					\begin{tabular}{|c|c|c|}
						...
						\textbf{Metodo di calcolo} & \textbf{Range accettazione} & \textbf{Range ottimale} \\
						\hline
						n° TS eseg/n° TS pianif & 75-100  & 85-100 \\
						\hline
					\end{tabular}
				\end{center}
			...
			\begin{table}[H]
				\begin{center}
					\begin{tabular}{|c|c|c|}
						...
						\textbf{Metodo di calcolo} & \textbf{Range accettazione} & \textbf{Range ottimale} \\
						\hline
						n° test superati/n° test eseguiti & 95-100  & 100 \\
						\hline
					\end{tabular}
				\end{center}
			...
			\begin{table}[H]
				\begin{center}
					\begin{tabular}{|c|c|c|}
						...
						\textbf{Metodo di calcolo} & \textbf{Range accettazione} & \textbf{Range ottimale} \\
						\hline
						89+((300*num frasi-10*num lett)/num par) & 40-100  & 55-100 \\
						\hline
					\end{tabular}
				\end{center}
			...
			\begin{table}[H]
				\begin{center}
					\begin{tabular}{|c|c|c|}
						...
						\textbf{Metodo di calcolo} & \textbf{Range accettazione} & \textbf{Range ottimale} \\
						\hline
						num linee cod monit da test/num linee cod implem in sw & xx  & yy \\
						\hline
					\end{tabular}
				\end{center}
