...
\section{Processi primari}
	...
	Per la progettazione, il gruppo ha deciso di utilizzare tre tipologie di diagrammi UML:
		\begin{itemize}
			\item Diagrammi dei packages\ped{G}: raggruppano le classi in un'unità di alto livello;
