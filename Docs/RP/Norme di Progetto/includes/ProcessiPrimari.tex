...
\section{Processi primari}
	...
	\subsection{Sviluppo}
		...
		Gli \textit{\Anas} hanno il compito di produrre il documento \textsc{\AdR 2\_0\_0.pdf} contenente un elenco di requisiti, con annesse peculiarità richieste ed informazioni sulla loro tipologia e rilevanza.
	...
	\subsubsection{Strumenti utilizzati}
		...
		Sublime Text è l'IDE scelto dal gruppo per la scrittura del codice. Sublime text è caratterizzato da un'interfaccia minimale, un'ampia gamma di features innovative e ottime prestazioni. L'editor è compatibile con diversi sistemi operativi ed è personalizzabile in molti aspetti. Una caratteristica rilevante è il \textit{Simultaneous editing}, ovvero la possibilità di modificare più porzioni di codice contemporaneamente cliccando nel punto esatto con il cursore, preceduto dal tasto shift. Le caratteristiche di personalizzazione riguardano i temi, l'interfaccia e le modalità di visione del codice. L'auto completamento del codice in base al linguaggio e il salvataggio automatico sono altre caratteristiche che hanno portato il gruppo a scegliere questo IDE.
