...
\section{Processi primari}
	...
	\subsubsection{Strumenti utilizzati}
		...
		Per il tracciamento dei documenti, preponderante specialmente nella fase di analisi e di progettazione, la scelta del team è ricaduta sull'utilizzo di uno strumento dedicato per permettere una più agevole gestione. Il software utilizzato è un fork di un progetto esistente, PragmaDB, creato da studenti degli scorsi anni che hanno intrapreso questa scelta, e modificato secondo le nostre esigenze. L'applicativo è grado di generare codice \textit{\LaTeX\ped{G}} a seguito di un indicizzazione dei requisiti all'interno del database. La possibilità di esportare le voci necessarie al tracciamento in maniera automatizzata rende il lavoro più uniforme ed ordinato.
		...
		\paragraph{Gulpease}
		Per verificare l'indice di leggibilità dei documenti, così come definito dal documento \textsc{PianoDiQualifica 1\_0\_0.pdf} è stato utilizzato lo strumento
