...
\subsubsection{Caso d'uso UC9.2: Scelta policy vendita API}
\label{UC9_2}
...
\begin{minipage}{\linewidth}
	\begin{tabular}{ l | p{11cm}}
		\hline
		\rowcolor{Gray}
		\multicolumn{2}{c}{UC9.2 - Scelta policy vendita API} \\
		\hline
		\textbf{Attori} & Cliente \\
...
\paragraph{Caso d'uso UC9.2.2: Scelta policy per tempo di utilizzo}
\label{UC9_2_2}
...
\begin{minipage}{\linewidth}
	\begin{tabular}{ l | p{11cm}}
		\hline
		\rowcolor{Gray}
		\multicolumn{2}{c}{UC9.2.2 - Scelta policy per tempo di utilizzo} \\
		\hline
		\textbf{Attori} & Cliente \\
...
\subsubsection{Caso d'uso UC9.3: Scelta blocco acquisto API}
\label{UC9_3}
...
\begin{minipage}{\linewidth}
	\begin{tabular}{ l | p{11cm}}
		\hline
		\rowcolor{Gray}
		\multicolumn{2}{c}{UC9.3 - Scelta blocco acquisto API} \\
		\hline
		\textbf{Attori} & Cliente \\
...
\subsubsection{Caso d'uso UC9.5: Conferma acquisto API}
\label{UC9_5}
...
\newpage
\subsubsection{Caso d'uso UC9.6: Riepilogo acquisto API}
\label{UC9_6}
\begin{figure}[ht]
	\centering
...
\paragraph{Caso d'uso UC9.6.1: Visualizzazione ringraziamento}
\label{UC9_6_1}
...
\begin{minipage}{\linewidth}
	\begin{tabular}{ l | p{11cm}}
		\hline
		\rowcolor{Gray}
		\multicolumn{2}{c}{UC9.6.1 - Visualizzazione ringraziamento} \\
		\hline
		\textbf{Attori} & Cliente \\
...
\paragraph{Caso d'uso UC9.6.3: Visualizzazione chiave API acquistata}
\label{UC9_6_3}
...
\begin{minipage}{\linewidth}
	\begin{tabular}{ l | p{11cm}}
		\hline
		\rowcolor{Gray}
		\multicolumn{2}{c}{UC9.6.3 - Visualizzazione chiave API acquistata} \\
		\hline
		\textbf{Attori} & Cliente \\
