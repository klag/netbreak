...
\begin{minipage}{\linewidth}
	\begin{tabular}{ l | p{11cm}}
		...
		\begin{enumerate*}[label=(\arabic*.),itemjoin={\newline}]
			...
			\item L'attore può visualizzare il logo dell'API (UC10.2.6)
			\item L'attore può visualizzare il guadagno dell'API (UC10.2.7)
		\end{enumerate*}\\
	\end{tabular}
\end{minipage}
...
\begin{minipage}{\linewidth}
	\begin{tabular}{ l | p{11cm}}
		\hline
		\rowcolor{Gray}
		\multicolumn{2}{c}{UC10.2.4.11 - Errore modifica PDF API} \\
		\hline
		\textbf{Attori} & Sviluppatore \\
...
\subparagraph{Caso d'uso UC10.2.4.7: Modifica policy vendita API}
\label{UC10_2_4_7}
...
\begin{minipage}{\linewidth}
	\begin{tabular}{ l | p{11cm}}
		\hline
		\rowcolor{Gray}
		\multicolumn{2}{c}{10.2.4.8 - Modifica logo API} \\
		\hline
		\textbf{Attori} & Sviluppatore \\
...
\subparagraph{Caso d'uso UC10.2.4.9: Conferma modifica API}
\label{UC10_2_4_9}
...
\begin{minipage}{\linewidth}
	\begin{tabular}{ l | p{11cm}}
		\hline
		\rowcolor{Gray}
		\multicolumn{2}{c}{UC10.2.4.9 - Conferma modifica API} \\
		\hline
		\textbf{Attori} & Sviluppatore \\
...
\paragraph{Caso d'uso UC10.2.6: Visualizzazione logo API}
\label{UC10_2_6}
...
\begin{minipage}{\linewidth}
	\begin{tabular}{ l | p{11cm}}
		\hline
		\rowcolor{Gray}
		\multicolumn{2}{c}{UC10.2.6 - Visualizzazione logo API} \\
		\hline
		\textbf{Attori} & Sviluppatore \\
...
\paragraph{Caso d'uso UC10.2.7: Visualizzazione guadagno API}
\label{UC10_2_7}
...
\begin{minipage}{\linewidth}
	\begin{tabular}{ l | p{11cm}}
		\hline
		\rowcolor{Gray}
		\multicolumn{2}{c}{UC10.2.7 - Visualizzazione guadagno API} \\
		\hline
		\textbf{Attori} & Sviluppatore \\
