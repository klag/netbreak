...
main {
  /*1. controllo correttezza interfacce, 
  ...
  */
  [getServiceMetaFromCourier( request )( response ) {
    ...
    [generateClientInterface( request )( response) {
       ...
       response += "outputPort "+request.name+"CalcService{\n";
       response += "  Location:\"socket://localhost:2002/!/Service"+request+"\"\n";
       response += "  Protocol:sodep\n";
       response += "  Interfaces: "+request.name+"Interface\n";
       response += "}"
